...
static byte channelOrder[NUM_OF_RGB_LEDS] = {1, 2, 3, 4, 0};
...
static byte channelOrder[NUM_OF_RGB_LEDS] = {0, 1, 2, 3, 4};

#endif

static byte incomingData[30]; // buffer array for incoming data over serial
